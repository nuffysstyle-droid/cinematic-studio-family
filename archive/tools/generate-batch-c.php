...
/**
 * bin/generate-batch-c.php — Batch C: Shop Covers #1–#5
 *
 * Assets:
 *   #1 Starter Crystal     → starter-crystal-cover.jpg (480x270)
 *   #2 TikTok Viral Pack   → tiktok-viral-cover.jpg (480x270)
 *   #3 Product Ad Pro      → product-ad-cover.jpg (480x270)
 *   #4 Anime Shift         → anime-shift-cover.jpg (480x270)
 *   #5 Pro Studio Bundle   → pro-bundle-cover.jpg (480x270)
 *
 * Usage:
 *   php bin/generate-batch-c.php
 */

$ASSETS = [
    [
        'name'     => 'Starter Crystal',
        'filename' => 'starter-crystal-cover.jpg',
        'prompt'   => 'Glowing crystal formation on dark cinematic background, volumetric light rays, deep blue and gold accents, premium digital art style, mysterious atmosphere, 16:9 composition',
    ],
    [
        'name'     => 'TikTok Viral Pack',
        'filename' => 'tiktok-viral-cover.jpg',
        'prompt'   => 'Neon-lit smartphone screen showing viral video metrics, pink and cyan studio lighting, energetic composition, social media aesthetic, dark background, 16:9 composition',
    ],
    [
        'name'     => 'Product Ad Pro',
        'filename' => 'product-ad-cover.jpg',
        'prompt'   => 'Professional product photography setup with ring light, camera on tripod, sleek minimal desk, soft shadows, premium studio environment, 16:9 composition',
    ],
    [
        'name'     => 'Anime Shift',
        'filename' => 'anime-shift-cover.jpg',
        'prompt'   => 'Split portrait half realistic half anime style, pastel color grading, sakura petals, dreamy bokeh, artistic transformation visual, 16:9 composition',
    ],
    [
        'name'     => 'Pro Studio Bundle',
        'filename' => 'pro-bundle-cover.jpg',
        'prompt'   => 'Professional film studio control room with multiple monitors, cinematic color grading interface, dark moody lighting, premium tech aesthetic, 16:9 composition',
    ],
];
...
$TARGET_H   = 270;
$TARGET_Q   = 85;
$TARGET_DIR = __DIR__ . '/../assets/showcase/shop';
$MAX_POLL   = 120;
$POLL_INT   = 5;
...
foreach ($ASSETS as $idx => $asset) {
    echo "\n═══════════════════════════════════════════════════════\n";
    echo "  BATCH C — " . ($idx + 1) . "/5: " . $asset['name'] . "\n";
    echo "═══════════════════════════════════════════════════════\n";
