...
/**
 * bin/generate-batch-b.php — Batch B: Portfolio #1, #8–#10
 *
 * Assets:
 ...
 *
 * Usage:
 *   export KIE_AI_API_KEY=... && php bin/generate-batch-b.php
 */

$ASSETS = [
    [
        'name'     => 'Nacht & Neon',
        'filename' => 'noir-trailer-v1.jpg',
        'prompt'   => 'Rain-soaked detective, cinematic drone shot, neon reflections, golden hour grade, film noir atmosphere, wet cobblestone streets, dramatic shadows, 16:9 composition',
    ],
    [
        'name'     => 'Summer Memories 4K',
        'filename' => 'restoration-v1.jpg',
        'prompt'   => 'Family picnic footage upgraded to cinematic 4K, color restoration, film grain added, warm sunlight, nostalgic to modern transformation, vivid greens and warm skin tones, 16:9 composition',
    ],
    [
        'name'     => 'Phoenix Rise',
        'filename' => 'fx-transform-v1.jpg',
        'prompt'   => 'Ordinary person transforms into fire-wielding hero, particle effects, cinematic showdown, dramatic backlight, golden fire particles, dark background with warm orange glow, 16:9 composition',
    ],
    [
        'name'     => 'Pure Essence',
        'filename' => 'hyperreal-ad-v1.jpg',
        'prompt'   => 'Luxury perfume bottle catching morning light, water droplets, ultra-sharp macro, premium feel, soft studio lighting, high-end commercial photography, minimalist composition, 16:9 composition',
    ],
];
