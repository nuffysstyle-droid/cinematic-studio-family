...
.page-sub{color:var(--muted);font-size:15px;line-height:1.6;max-width:560px;margin-bottom:40px;}
.live-badge{display:inline-flex;align-items:center;gap:8px;background:rgba(74,222,128,.08);border:1px solid rgba(74,222,128,.28);border-radius:999px;padding:7px 16px;font-size:13px;font-weight:800;color:var(--ok);margin-bottom:32px;}
.live-dot{width:8px;height:8px;border-radius:50%;background:var(--ok);box-shadow:0 0 10px var(--ok);animation:pulse 2s ease-in-out infinite;}
@keyframes pulse{0%,100%{opacity:1;transform:scale(1)}50%{opacity:.4;transform:scale(1.3)}}
.coming-card{background:linear-gradient(145deg,rgba(74,222,128,.04),rgba(59,130,246,.02));border:1px solid rgba(74,222,128,.16);border-radius:var(--radius);padding:52px 40px;text-align:center;margin-bottom:28px;}
...
<div class="page">
  <div class="wrap">
    <div class="page-eyebrow">📅 Verfügbarkeit</div>
    <h1 class="page-h1">Kapazität &amp;<br><span>Buchung</span></h1>
    <div class="live-badge"><span class="live-dot"></span>Studio aktuell verfügbar</div>
