...
.gem-hero{font-size:3.4rem;display:block;margin-bottom:20px;animation:gfloat 3.5s ease-in-out infinite;}
...
.pack{background:var(--card);border:1px solid var(--border);border-radius:var(--radius);padding:28px 22px;text-align:center;transition:transform .2s,border-color .2s,box-shadow .2s;}
.pack:hover{transform:translateY(-4px);border-color:rgba(245,197,66,.35);box-shadow:0 16px 44px rgba(0,0,0,.4),0 0 40px rgba(245,197,66,.08);}
.pack.featured{border-color:rgba(245,197,66,.32);background:linear-gradient(145deg,rgba(245,197,66,.07),var(--card));}
.pack-gem{font-size:2rem;margin-bottom:12px;}
.pack-name{font-size:13px;font-weight:700;color:var(--muted);margin-bottom:8px;letter-spacing:.5px;}
.pack-crystals{font-size:2rem;font-weight:900;background:var(--gold);-webkit-background-clip:text;-webkit-text-fill-color:transparent;margin-bottom:6px;}
.pack-price{color:var(--muted);font-size:13px;margin-bottom:12px;}
