...
<title>Shop – Cinematic Vision Studio</title>
<style>
:root{--bg:#06060f;--s1:#0d0d1a;--ac:#f59e0b;--tx:#e2e8f0;--txm:#94a3b8;--br:#ffffff12}
...
.page-icon{font-size:3.5rem;margin-bottom:20px;filter:drop-shadow(0 0 24px rgba(245,158,11,.4))}
.page-badge{display:inline-flex;align-items:center;gap:6px;background:rgba(245,158,11,.1);border:1px solid rgba(245,158,11,.3);color:#fcd34d;font-size:.72rem;font-weight:600;letter-spacing:.06em;text-transform:uppercase;padding:4px 12px;border-radius:20px;margin-bottom:18px}
h1{font-size:clamp(2rem,6vw,3rem);font-weight:800;margin-bottom:16px;background:linear-gradient(135deg,#fcd34d,#f97316);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
.page-sub{color:var(--txm);font-size:1.05rem;line-height:1.7;max-width:520px;margin:0 auto 48px}
.coming-card{background:var(--s1);border:1px solid rgba(245,158,11,.2);border-radius:20px;padding:40px;max-width:480px;margin:0 auto 40px}
.coming-card h2{font-size:1.1rem;font-weight:700;margin-bottom:12px;color:#fcd34d}
...
.back-link:hover{color:var(--tx);border-color:rgba(245,158,11,.4);background:rgba(245,158,11,.06)}
</style>
</head>
<body>
<nav class="top-nav">
...
<div class="page-wrap">
  ...
  <div class="page-badge">Shop</div>
  <h1>Studio<br>Shop</h1>
  <p class="page-sub">Pakete, Einzelleistungen und digitale Produkte – direkt kaufen und sofort einsetzen.</p>
  <div class="coming-card">
    <h2>🛍️ Shop im Aufbau</h2>
