...
.coming-card{background:linear-gradient(145deg,rgba(245,197,66,.04),rgba(255,140,0,.02));border:1px solid rgba(245,197,66,.18);border-radius:var(--radius);padding:52px 40px;text-align:center;margin-bottom:28px;}
...
<nav class="nav">
  ...
  <div class="nav-links">
    ...
    <a href="shop.php" class="nav-link active">Shop Beta</a>
...
<div class="mob-menu" id="mobMenu">
  ...
  <a href="shop.php" class="mob-link active">🛍️ Shop Beta</a>
